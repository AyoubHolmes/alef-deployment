      ...
      case 'art-exhibitions':
        result = await prisma.artExhibition.create({
          data: {
            ...
            localisationAr: activityData.localisationAr || '',
            localisationFr: activityData.localisationFr || '',
            organizersAr: activityData.organizersAr || '',
            organizersFr: activityData.organizersFr || '',
