...
const VisualArts = () => {
  ...
  const handleReadArticle = (articleId: number) => {
    router.push(`/activities/visual-arts/article/${articleId}`);
  };
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className={`text-4xl font-bold mb-4 ${language === 'ar' ? 'font-cairo' : 'font-montserrat'}`}>
            {language === 'ar' ? 'الفنون البصرية' : 'Arts Visuels'}
          </h1>
          <p className="text-lg text-gray-600">
            {language === 'ar' 
              ? 'مجموعة من المقالات المتخصصة في الفنون البصرية والتشكيلية'
              : 'Collection d\'articles spécialisés en arts visuels et plastiques'
            }
          </p>
        </div>
