...
const AdminPublicationsArtChiv: React.FC = () => {
  ...
  const [articles, setArticles] = useState<ArtChivArticle[]>([
    {
      id: 1,
      title: { 
        ar: 'مقال أرت شيف الأول', 
        fr: 'Premier Article ArtChiv' 
      },
      author: { 
        ar: 'د. سارة الفنانة', 
        fr: 'Dr. Sarah Fannana' 
      ...
      content: { 
        ar: 'هذا نص مقال أرت شيف باللغة العربية...', 
        fr: 'Ceci est le contenu de l\'article ArtChiv en français...' 
      },
      excerpt: { 
        ar: 'مقتطف من مقال أرت شيف...', 
        fr: 'Extrait de l\'article ArtChiv...' 
      }
    },
    {
      id: 2,
      title: { 
        ar: 'مقال أرت شيف الثاني', 
        fr: 'Deuxième Article ArtChiv' 
      },
      author: { 
        ar: 'أ. أحمد المؤرخ', 
        fr: 'Prof. Ahmed Mouarekh' 
      },
      date: '2024-01-10',
      status: { ar: 'مسودة', fr: 'Brouillon' },
      content: { 
        ar: 'هذا نص المقال الثاني لأرت شيف باللغة العربية...', 
        fr: 'Ceci est le contenu du deuxième article ArtChiv en français...' 
      },
      excerpt: { 
        ar: 'مقتطف من المقال الثاني لأرت شيف...', 
        fr: 'Extrait du deuxième article ArtChiv...' 
      }
    }
  ]);
  ...
  const handleEdit = (article: ArtChivArticle) => {
      ...
      <div dir={language === 'ar' ? 'rtl' : 'ltr'} className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className={`text-2xl font-bold ${language === 'ar' ? 'font-cairo' : 'font-montserrat'}`}>
            {language === 'ar' ? 'إدارة أرت شيف' : 'Gestion ArtChiv'}
          </h1>
...
export default AdminPublicationsArtChiv;