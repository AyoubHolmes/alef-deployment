...
const TeamManager: React.FC = () => {
  ...
  const labels = {
    teamManagement: { ar: 'إدارة فريق العمل', fr: 'Gestion de l\'équipe' },
  ...
  const handleSave = () => {
    localStorage.setItem('teamContent', JSON.stringify(content));
    localStorage.setItem('team', JSON.stringify(content.members));
      ...
      <Tabs defaultValue="ar" className="w-full">
        ...
        <TabsContent value="ar" className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="عنوان صفحة فريق العمل"
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle>{getLabel('teamMembers')} - العربية</CardTitle>
        ...
        <TabsContent value="fr" className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Titre de la page équipe"
                />
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{getLabel('teamMembers')} - Français</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              {content.members.map((member, index) => (
                <div key={member.id} className="p-4 border rounded-lg space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="Poste du membre en français"
                      />
                    </div>
                  </div>
